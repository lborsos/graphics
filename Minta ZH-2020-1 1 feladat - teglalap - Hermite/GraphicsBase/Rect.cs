...
namespace GraphicsBase
{
    internal class Rect
    {
        ...
        {
            return new Vector2F((float)(x + width), (float)y);
        }
        public Vector2F Right2Top()
        {
            return new Vector2F((float)(x + width + width), (float)y);
        }
        ...
        {
            return new Vector2F((float)(x + width), (float)(y + height));
        }
        public Vector2F Right2Bottom()
        {
            return new Vector2F((float)(x + width + width), (float)(y + height));
        }
        public Vector2F LeftBottom()
        {
            return new Vector2F((float)x, (float)(y + height));
        }
    }
}
